...
<head>
<meta charset="utf-8">
<title>American Airline flights</title>
<!-- Stylesheets -->
                ...
                <div class="inner clearfix">
                    <div class="top-left clearfix">
                        <ul class="info clearfix">
                            <li><i class="icon fa fa-envelope"></i> <a href="mailto:INFO@American Airline flights.COM">Americanairlineflights@usa.com</a></li>
                    ...
                    <div class="top-right clearfix">
                        ...
                        <div class="login"><i class="icon fa fa-user"></i> <a href="{{url('signin')}}">SIGN IN</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="header-upper">        
            <div class="auto-container">
                ...
                <div class="main-box clearfix">
                    <!--Logo-->
                    <div class="logo-box">
                         <div class="logo"><a href="{{url('/')}}" title="American Airline flights">American Airline Flight</a></div>
                    </div>
                        ...
                        <div class="nav-outer clearfix">         
                            <nav class="main-menu">
                                ...
                                <li><a href="{{url('welcome')}}">Home</a>
                                       ...
                                       <li><a href="{{url('available-flight')}}">Available Flights</a>
    ...
    <section class="hidden-bar">
        ...
        <div class="hidden-bar-wrapper">
            ...
            <div class="nav-logo-box">
                <div class="logo"><a href="index.html" title="American Airline flights"><img src="{{asset('images/logo.svg')}}" alt="" title="American Airline flights"></a></div>
            </div>
            <!-- .Side-menu -->
            <div class="side-menu">
                 <ul class="navigation clearfix">
            ...
            <div class="links-box clearfix">
                <div class="clearfix">
                    <div class="link"><a href="{{url('signin')}}" class="theme-btn btn-style-one"><span>Login<i class="icon far fa-angle-right"></i></span></a></div>
