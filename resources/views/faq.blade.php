@include('header')
 ...
 <section class="inner-banner">
    ...
    <section class="faq-two">
        <div class="floated-icon left"><img src="images/resource/stones-left_2.svg" alt="" title=""></div>
        <div class="floated-icon right"><img src="images/resource/stones-right_2.svg" alt="" title=""></div>
        <div class="auto-container">
